...
export default function BookPage() {
  ...
  const setVendors = (newVendors: BookingVendorSelection) => {
                    ...
                    <div className="bg-white dark:bg-[#111111] border border-[#E8DFC9] dark:border-gray-800 p-6 rounded-sm space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                        <div className="space-y-2">
                          ...
                          <p><span className="text-gray-500">Date:</span> {selectedDate ? new Date(selectedDate).toLocaleDateString(undefined, { weekday: "long", year: "numeric", month: "long", day: "numeric" }) : "Not selected"}</p>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="bg-[#FAF6EE] dark:bg-white/5 p-2 rounded-sm border border-[#E8DFC9] dark:border-gray-800 space-y-1">
                            <p className="text-[11px] font-bold text-[#805D3A] dark:text-[#C9A84C]">30% Deposit: {formatCurrency(depositToday)}</p>
                            <p className="text-[9px] text-gray-500">Balance: {formatCurrency(balanceDue)}</p>
                          </div>
                        </div>
                      </div>
                          ...
                          {(["decorator", "dj", "videographer"] as const).map((cat) => {
                            ...
                            return (
                              <div key={cat} className="border border-gray-100 dark:border-gray-800 p-3 rounded-sm bg-[#FAFBF7] dark:bg-white/5">
                                ...
                                <p className="font-medium text-gray-800 dark:text-gray-200">{isNone ? "Not Required" : (v ? v.name : "Custom Selected")}</p>
                              </div>
                            );
                          })}
                        </div>
                      ...
                      <div className="p-4 bg-[#FAF6EE] dark:bg-white/5 border border-[#E8DFC9] dark:border-white/10 rounded-sm">
                        <h4 className="text-[10px] uppercase tracking-widest font-bold text-[#A6955C] mb-2">Cancellation Policy</h4>
                    ...
                    <div className="bg-white dark:bg-[#111111] p-6 border border-[#E8DFC9] dark:border-gray-800 rounded-sm">
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between border-b border-gray-100 dark:border-gray-800 pb-3 text-sm">
                          ...
                          <span className="font-bold text-[#1A1512] dark:text-white">{selectedDate ? new Date(selectedDate).toLocaleDateString(undefined, { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' }) : 'Not selected'}</span>
                        </div>
                        <div className="flex justify-between border-b border-gray-100 dark:border-gray-800 pb-3 text-sm">
                      ...
                      <div className="mt-8 p-4 bg-[#FAF6EE] dark:bg-white/5 border border-[#E8DFC9] dark:border-white/10 rounded-sm">
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed space-y-1">
                          • <strong>More than 30 days before event:</strong> Free cancellation directly from your dashboard.<br />
                          • <strong>Between 14 and 30 days before event:</strong> Cancellation requires Manager review and approval.<br />
                          • <strong>Less than 14 days before event:</strong> Cancellation is no longer possible through the portal. Please contact the hotel directly.
                        </p>
                      </div>
