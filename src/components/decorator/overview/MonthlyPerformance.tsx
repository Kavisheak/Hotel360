...
const bars = [
  { month: 'JAN', value: '45%', tone: 'light' },
  { month: 'FEB', value: '60%', tone: 'light' },
  { month: 'MAR', value: '84%', tone: 'dark' },
  { month: 'APR', value: '55%', tone: 'light' },
  { month: 'MAY', value: '70%', tone: 'light' },
  { month: 'JUN', value: '94%', tone: 'dark' },
];
  ...
  return (
    <article className="min-h-[560px] border border-[#E7DDCC] bg-[#F8F4EC] p-6 lg:p-8">
      <div className="mb-12 flex items-start justify-between gap-4">
       <h2 className="mb-2 text-[28px] font-serif text-gray-800">Monthly Performance</h2>
