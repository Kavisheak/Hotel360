    ...
    <div className="bg-white border border-[#E0D8C3] p-6 sm:p-8 shadow-sm flex flex-col justify-between">
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
          ...
          <div>
            <label className="block text-[10px] font-bold text-gray-400 tracking-wider mb-2 uppercase">
              STARTING PRICE (e.g. LKR 450,000)
            </label>
            <input
              type="text"
              name="startingPrice"
          ...
          <div>
            ...
            <input 
              ...
              className="w-full px-4 py-3 text-sm border border-[#E0D8C3] bg-[#FDF9F1] text-gray-700 focus:outline-none focus:border-[#B08D2C]"
            />
