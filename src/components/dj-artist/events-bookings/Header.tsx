    ...
    <section className="mb-8 mt-4 flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
      <div className="max-w-3xl">
        ...
        <p className="mt-3 max-w-2xl font-serif text-lg italic text-[#807157] sm:text-[20px]">
          Manage assigned events, booking statuses, and upcoming schedule priorities.
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-3 lg:pt-2">
        ...
        <button className="inline-flex items-center gap-2 bg-[#9A7A10] px-6 py-3 text-[11px] font-semibold tracking-[0.22em] text-white transition hover:bg-[#84680E]">
          <Plus size={16} />
          NEW BOOKING
        </button>
      </div>
