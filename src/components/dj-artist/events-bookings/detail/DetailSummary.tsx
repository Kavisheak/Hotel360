...
const DetailSummary = ({ date, guests, shootWindow, venue }: DetailSummaryProps) => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <div className="bg-white border border-[#E0D8C3] p-5 shadow-sm flex flex-col justify-between min-h-[110px]">
        ...
        <div>
          <p className="text-[9px] font-bold tracking-[0.15em] text-gray-400 uppercase mb-1">SHOOT WINDOW</p>
          <p className="text-lg font-serif font-bold text-gray-900 leading-tight">{shootWindow}</p>
        </div>
      </div>
