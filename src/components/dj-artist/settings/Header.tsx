    ...
    <div className="mb-8 mt-4">
      <div className="flex items-center justify-between border-b border-[#E0D8C3] pb-4 mb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h4 className="text-xs font-bold text-gray-800 tracking-wide">DJ Artist Portal</h4>
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
        <div className="max-w-2xl">
          ...
          <p className="text-sm text-gray-500 leading-relaxed font-sans">
            Curate your elite profile, booking presence, and account preferences for the season ahead.
          </p>
        </div>
