  ...
  return (
    <div className="border-b border-[#E0D8C3] bg-[#FDF9F1] px-10 py-4 flex justify-between items-center sticky top-0 z-10">
      <div className="flex items-center space-x-6">
        <div>
          <p className="text-[10px] font-bold tracking-widest text-gray-500 uppercase mb-1">Performance</p>
      ...
      <div className="flex items-center space-x-4">
        <div className="text-right">
          <p className="text-sm font-bold text-gray-800">Ahmed Sattar</p>
          <p className="text-[10px] font-bold tracking-widest text-gray-500 uppercase">Lead DJ Artist</p>
        </div>
