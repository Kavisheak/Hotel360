    ...
    >
      {stats.map((stat, idx) => (
        ...
        >
          <Link 
            href={stat.link}
            className="bg-white border border-[#D4C9A8] p-5 shadow-sm rounded-sm hover:border-[#C9A84C] hover-lift hover-glow transition-all duration-300 block card-entrance"
          >
