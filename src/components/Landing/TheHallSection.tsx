...
const TheHallSection = () => {
  return (
    <section className="w-full bg-[#fcfaf7] py-16 md:py-20 px-6 md:px-12 lg:px-20 flex justify-center">
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
        
        {/* Left Column */}
        <div className="flex flex-col justify-center">
          <p className="text-[#c69c6d] text-[10px] tracking-[0.2em] uppercase font-semibold mb-6">
            The Hall
          </p>
