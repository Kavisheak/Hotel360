...
export default function VendorsTrust() {
  return (
    <section className="bg-[#2C1E14] text-white py-12 px-6 border-t border-[#C9A84C]/20 mt-12 section-reveal">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div className="space-y-2 border-b md:border-b-0 md:border-r border-[#C9A84C]/20 pb-6 md:pb-0 md:pr-8 hover-lift stagger-2">
          <div className="flex justify-center md:justify-start text-[#C9A84C]">
