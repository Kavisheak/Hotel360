...
export default function TrustSection() {
  return (
    <section className="bg-white dark:bg-[#0A0A0A] text-[#2C1E14] dark:text-white py-12 px-6 border-t border-[#D4C9A8]/30 dark:border-[#C9A84C]/20">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left section-reveal">
        
        <div className="space-y-2 border-b md:border-b-0 md:border-r border-[#D4C9A8] dark:border-[#C9A84C]/20 pb-6 md:pb-0 md:pr-8 hover-lift">
