    ...
    <div className="space-y-8 hover-glow p-4 md:p-6 rounded-sm transition-all duration-300 bg-white dark:bg-[#111111] border border-[#D4C9A8] dark:border-[#C9A84C]/20 shadow-[0_0_20px_rgba(128,93,58,0.05)] dark:shadow-[0_0_20px_rgba(201,168,76,0.05)]">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="space-y-6">
          <h4 className="text-base font-serif font-semibold text-[#2C1E14] dark:text-white">Primary Contact (Auto-filled)</h4>
          ...
          <div>
            ...
            <textarea 
              rows={3}
              className="w-full border border-[#D4C9A8] dark:border-[#C9A84C]/30 bg-[#FDFBF7] dark:bg-[#1A1A1A] p-3 text-base text-[#2C1E14] dark:text-white focus:border-[#805D3A] dark:focus:border-[#C9A84C] outline-none transition-colors rounded-sm input-glow"
          ...
          {formData.paymentMethod === "Card" ? (
            ...
            <div>
              ...
              <input 
                ...
                className="w-full border border-[#D4C9A8] dark:border-[#C9A84C]/30 bg-[#FDFBF7] dark:bg-[#0A0A0A] text-[#2C1E14] dark:text-white px-3 py-2 text-base focus:border-[#805D3A] dark:focus:border-[#C9A84C] outline-none transition-colors rounded-sm input-glow"
            ...
            <div className="bg-[#F0E6D0] dark:bg-[#1A1A1A] p-5 border border-[#D4C9A8] dark:border-[#C9A84C]/30 rounded-sm space-y-3 shadow-inner animate-fadeIn">
              <h5 className="text-sm font-bold uppercase tracking-widest text-[#805D3A] dark:text-[#C9A84C]">Manual Advance Payment</h5>
