    ...
    <footer className="w-full bg-[#151210] border-t border-[#c69c6d]/20 text-[#2C1E14] dark:text-white">
      <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-wrap justify-center gap-8 text-[10px] uppercase tracking-widest text-gray-600 dark:text-gray-400 font-semibold">
          ...
          <Link href="/packages" className="text-[#C69C6D] hover:text-[#2C1E14] dark:text-white transition-colors duration-200">Packages</Link>
          ...
          <Link href="/virtual-tour" className="hover:text-[#2C1E14] dark:text-white transition-colors duration-200">Book</Link>
        </div>
