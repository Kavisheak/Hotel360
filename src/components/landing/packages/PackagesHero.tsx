...
export default function PackagesHero() {
  return (
    <section className="relative w-full py-24 bg-white dark:bg-[#0A0A0A] text-[#2C1E14] dark:text-white overflow-hidden border-b border-[#D4C9A8]/30 dark:border-[#C9A84C]/20">
      {/* Background Image */}
