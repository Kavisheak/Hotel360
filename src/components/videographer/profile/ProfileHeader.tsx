      ...
      <div className="flex items-center justify-between border-b border-[#E0D8C3] pb-4 mb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-[9px] font-bold text-gray-400 tracking-widest uppercase mt-0.5">PROFILE & SETTINGS</p>
          </div>
        </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
        <div className="max-w-2xl">
          ...
          <p className="text-sm text-gray-500 leading-relaxed font-sans">
            Manage your videographer profile, update security credentials, and refine your portfolio information.
          </p>
        </div>
