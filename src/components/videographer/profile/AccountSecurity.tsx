    ...
    <div className="flex flex-col gap-6">
      <div className="bg-white border border-[#E0D8C3] p-6 sm:p-8 shadow-sm">
        <div className="flex items-center space-x-2 border-b border-[#E0D8C3] pb-3 mb-6">
          ...
          <h3 className="text-xs font-bold tracking-[0.2em] text-[#7C6A2E] uppercase">ACCOUNT SECURITY</h3>
        </div>
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="flex items-center justify-between border-b border-gray-50 pb-4">
            ...
            <button
              ...
              className={`w-11 h-6 rounded-full transition-colors relative focus:outline-none ${tfaActive ? 'bg-[#7C6A2E]' : 'bg-gray-200'}`}
            >
              <div
        ...
        <div className="space-y-4">
          <p className="text-[8px] font-bold text-gray-400 tracking-[0.15em] uppercase">LAST LOGIN: TODAY AT 09:42 AM</p>
